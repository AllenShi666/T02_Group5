...
public class MonthCalendarView {
	...
	public MonthCalendarView(YearMonth currYearMonth) {
        ...
        //NEW CODE
        Button new_event=new Button("NewEvent");
        Label label=new Label ("Click");
        
        HandleButtonClick handler=new HandleButtonClick(label);
        new_event.setOnAction(handler);
        ...
        for (int i = 0; i < 5; i++) {
            for (int j = 0; j < 7; j++) {
                ...
                dayPane.getChildren().add(new_event);
